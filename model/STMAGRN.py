...
#         self.m = Memory(T=self.horizon, num_nodes=self.num_nodes, model_dim=self.model_dim, mem_dim=self.mem_dim)
#         # 寻找图特征
...
#         # mambaEncoder
#         x_mb = self.mamba(x.reshape(-1, self.horizon * self.num_nodes, self.model_dim)).reshape(x.shape)
